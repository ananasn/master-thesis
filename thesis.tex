...
\def\contentsname{\textsc{Содержание}}
\def\appendixname{\textsc{Приложение}}
\def\tocpretheappendix{\textsc{\protect\appendixname~}}
%\def\conclusionname{Выводы}
\def\bibname{\textsc{Список используемых источников}}
...
\topic{Обоснование применения ... }

% Автор
\author{Крылова Анастасия Андреевна} % ФИО
\group{Р4275} % Группа
\coursenum{09.04.01} % Номер специальности
